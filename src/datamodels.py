...
class RecipeModel(BaseModel):
    ...
    recipe_ingredients: Literal[
        ...
        "uova di fenice",
        "zucchero cosmico",
    ] = Field(default=None, description="List of ingredients that compose a recipe")
    recipe_techniques: Literal[
    ...
    ] = Field(default=None, description="List of techniques used in the recipe")
